-- this is the 1st part of the 9.0.7.2 to 9.1.0.0 upgrade
...
-- This statement always should be at the end to upgrade to 9.1.0.0 , please do not move it to some other place --

update ts_domains set ts_db_versions='9.1.0.0';
