...
alter table ts_sm_web_servers 
    ...
    foreign key (ts_sm_group_id) 
    references ts_sm_groups on delete cascade;
alter table ts_stats_ts_all_daily 
    add constraint FK76A257B39DADA24 
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_ts_all_interval 
    add constraint FK5F73CCEB9DADA24 
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_ts_all_monthly 
    add constraint FK4BB10B279DADA24 
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_ts_all_weekly 
    add constraint FK7E4B3A279DADA24 
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_ts_usgrp_interval 
...
alter table ts_stats_ts_usgrp_monthly 
...
alter table ts_stats_ts_usgrp_monthly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_ts_usgrp_weekly 
...
alter table ts_stats_ts_usgrp_weekly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_ts_us_daily 
...
alter table ts_stats_ts_us_daily 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_ts_us_interval 
...
alter table ts_stats_ts_us_interval 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_ts_us_monthly 
...
alter table ts_stats_ts_us_monthly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_ts_us_weekly 
...
alter table ts_stats_ts_us_weekly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_ts_usgrp_daily 
...
alter table ts_stats_tsgrp_usgrp_daily 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tsgrp_usgrp_interval 
...
alter table ts_stats_tsgrp_usgrp_interval 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tsgrp_usgrp_monthly 
...
alter table ts_stats_tsgrp_usgrp_monthly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tsgrp_usgrp_weekly 
...
alter table ts_stats_tsgrp_usgrp_weekly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tsgrp_us_daily 
...
alter table ts_stats_tsgrp_us_daily 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tsgrp_us_interval 
...
alter table ts_stats_tsgrp_us_interval 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tsgrp_us_monthly 
...
alter table ts_stats_tsgrp_us_monthly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tsgrp_us_weekly 
...
alter table ts_stats_tsgrp_us_weekly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tu_all_daily 
...
alter table ts_stats_tu_all_daily 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tu_all_interval 
...
alter table ts_stats_tu_all_interval 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tu_all_monthly 
...
alter table ts_stats_tu_all_monthly 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tu_all_weekly 
...
alter table ts_stats_tu_all_weekly 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tu_usgrp_daily 
...
alter table ts_stats_tu_usgrp_daily 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tu_usgrp_interval 
...
alter table ts_stats_tu_usgrp_interval 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tu_usgrp_monthly 
...
alter table ts_stats_tu_usgrp_monthly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tu_usgrp_weekly 
...
alter table ts_stats_tu_usgrp_weekly 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tu_us_daily 
...
alter table ts_stats_tu_us_daily 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tu_us_interval 
...
alter table ts_stats_tu_us_interval 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tu_us_monthly 
...
alter table ts_stats_tu_us_monthly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_tu_us_weekly 
