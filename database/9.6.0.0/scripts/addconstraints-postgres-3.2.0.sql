...
alter table ts_defect_meta_values 
    ...
    references ts_defect_meta_keys;
alter table ts_defect_meta_values 
...
alter table ts_defects 
    add constraint FK34AA2B6222B94AEE 
    foreign key (ts_tranunit_id) 
    references ts_tranunits;
alter table ts_defects 
    add constraint FK34AA2B629DADA24 
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_defects 
    ...
    references ts_users;
alter table ts_defects 
    add constraint FK34AA2B62B62FC018 
    foreign key (ts_trancomp_id) 
    references ts_trancomps;
alter table ts_defects 
    add constraint FK34AA2B62C6CF0E07 
    foreign key (ts_monitor_id) 
    references ts_monitors;
alter table ts_defects 
    add constraint FK34AA2B62F081AE66 
    foreign key (ts_biz_event_id) 
    references ts_biz_events on delete cascade;
alter table ts_defects 
    add constraint FK34AA2B624AD9EEC4 
    foreign key (ts_defect_def_id) 
    references ts_defect_defs;
...
alter table ts_report_type_param_values
    ...
    foreign key (ts_param_key_id)
    references ts_report_param_keys;
...
alter table ts_stats_transet_all_daily 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_transet_all_interval 
...
alter table ts_stats_transet_userGroup_monthly 
...
alter table ts_stats_transet_user_weekly 
    ...
    foreign key (ts_user_id) 
    references ts_users;
alter table ts_stats_transet_usergroup_daily 
...
alter table ts_stats_transet_usergroup_daily 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_transetgroup_all_daily 
    add constraint FK13C22764AAF0715E 
    foreign key (ts_transet_group_id) 
    references ts_transet_groups;
alter table ts_stats_transetgroup_all_interval 
    add constraint FK185E139AAAF0715E 
    foreign key (ts_transet_group_id) 
    references ts_transet_groups;
alter table ts_stats_transetgroup_all_monthly 
    add constraint FK201BB298AAF0715E 
    foreign key (ts_transet_group_id) 
    references ts_transet_groups;
alter table ts_stats_transetgroup_all_weekly 
    add constraint FK85256096AAF0715E 
    foreign key (ts_transet_group_id) 
    references ts_transet_groups;
alter table ts_stats_transetgroup_userGroup_daily 
...
alter table ts_stats_transetgroup_userGroup_daily 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_transetgroup_userGroup_interval 
...
alter table ts_stats_transetgroup_userGroup_interval 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_transetgroup_userGroup_monthly 
...
alter table ts_stats_tranunit_all_daily 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tranunit_all_interval 
...
alter table ts_stats_tranunit_all_interval 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tranunit_all_monthly 
...
alter table ts_stats_tranunit_all_monthly 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tranunit_all_weekly 
...
alter table ts_stats_tranunit_all_weekly 
    ...
    foreign key (ts_transet_id) 
    references ts_transets;
alter table ts_stats_tranunit_userGroup_daily 
...
alter table ts_stats_tranunit_userGroup_daily 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tranunit_userGroup_interval 
...
alter table ts_stats_tranunit_userGroup_interval 
    ...
    foreign key (ts_userGroup_id) 
    references ts_user_groups;
alter table ts_stats_tranunit_userGroup_monthly 
