...
insert into ts_domains(ts_id, ts_name, ts_ip_address, ts_port, ts_db_versions, ts_tran_importance_id, ts_user_importance_id, version_info, ts_dynamic_group_reassign) values (1, 'Local Domain', 0, 80, '9.6.0.0', 5, 5, 1, false);
...
Insert into ts_sm_groups(ts_name, ts_cookie_name, ts_shared_secret, ts_apiversion, ts_enabled, ts_soft_delete, version_info) values('Default SiteMinder Group', 'SMSESSION', 'Enter Shared Secret here', '4', false, false, 1);
...
insert into ts_introscope_ems(version_info, ts_name, ts_description, ts_username, ts_password, ts_hostname, ts_em_version, ts_web_view_version, ts_web_start_version, ts_port, ts_web_view_port, ts_web_start_port, ts_has_web_view, ts_has_web_start, ts_tran_trace_duration, ts_tran_trace_threshold_percnt, ts_enabled, ts_soft_delete)
 values (1, '', '', '','','localhost', '9.6.0.0', '', '',5001, 8080, 8081, false, false, 30, 50, false, false);
...
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1040, 1, 'servicedesk.usd_user', '', 'servicedesk username', '', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1041, 1, 'servicedesk.usd_host', '', 'servicedesk host', '', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1042, 1, 'servicedesk.usd_port', '', 'servicedesk port', '8080', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1043, 1, 'servicedesk.usd_password', '', 'servicedesk password', '', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1044, 1, 'servicedesk.enableusdplugin', 'false', 'enable service desk plugin', 'false', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1045, 1, 'servicedesk.issuecategory', '', 'category of issue', '', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1046, 1, 'servicedesk.cem_host', '', 'cem host', '', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1047, 1, 'servicedesk.cem_port', '', 'cem port', '8081', false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1048, 1, 'servicedesk.issuefilter','','issue filter','*/*',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1049, 1, 'servicedesk.issuedescription','','issue description','',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1050, 1, 'servicedesk.issuesummary','','issue summary','',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1051, 1, 'servicedesk.enablelow','true','enable low severity','true',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1052, 1, 'servicedesk.enablemoderate','true','enable moderate severity','true',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1053, 1, 'servicedesk.enablesevere','true','enable severe severity','true',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1054, 1, 'servicedesk.enablecritical','true','enable critical severity','true',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1055, 1, 'servicedesk.incidentlink','http://[HOST]:[PORT]/wily/cem/tess/app/biz/bizEventDetail.html?pId=[INCIDENT_ID]','direct incident link','',false);
insert into ts_settings(ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values (1056, 1, 'servicedesk.use_itil', 'true', 'use ITIL', 'true', false);
...
-- event 7 is for a 9.2 tim feature (tim as software) that was not ported to 9.5

insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(3, 0, 'Enterprise Manager cannot reach TIM', 'error', 'Communications', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(4, 0, 'No network data', 'warning', 'Communications', 30);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(5, 0, 'Enterprise Manager restarted', 'informational', 'Administration', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(6, 0, 'TIM restarted', 'informational', 'Administration', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(7, 0, 'TIM Time Not Synchronized', 'informational', 'Administration', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(9, 0, 'Introscope unreachable', 'error', 'Administration', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(10, 0, 'User group limit reached', 'warning', 'Processing', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(11, 0, 'Logins dropped', 'warning', 'Processing', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(12, 0, 'Defects dropped', 'warning', 'Processing', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(14, 0, 'Business application name is not valid', 'error', 'CA APM TG', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(15, 0, 'CA APM TG Agent is down', 'warning', 'CA APM TG', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(16, 0, 'CA APM TG Agent is up', 'informational', 'CA APM TG', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(17, 0, 'Duplicate session ids detected', 'warning', 'Monitoring', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(18, 0, 'HTTP Analyzer plug-in error', 'error', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(21, 0, 'Discovered transactions dropped', 'warning', 'Processing', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(22, 0, 'TIM Collection Service has started', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(23, 0, 'TIM Collection Service has stopped', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(24, 0, 'Stats Aggregation Service has started', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(25, 0, 'Stats Aggregation Service has stopped', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(26, 0, 'Database Cleanup Service has started', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(27, 0, 'Database Cleanup Service has stopped', 'informational', 'Processing', 0);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(28, 0, 'Limit exceeded adding new components', 'warning', 'Processing', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(29, 0, 'TIM deleted some of its data files because disk space was low', 'informational', 'Administration', 60);
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(30, 0, 'Enterprise Manager deleted some TIM data files because the lag-time threshold was met', 'informational', 'Administration', 60);
...
insert into tang_event_types(ts_id, version_info, ts_name, ts_severity, ts_category, ts_frequency) values(32, 0, 'Errors processing statistics file(s).  See EM log for details.', 'error', 'Processing', 60);
