...
insert into ts_domains(ts_id, ts_name, ts_ip_address, ts_port, ts_db_versions, ts_tran_importance_id, ts_user_importance_id, version_info, ts_dynamic_group_reassign) values (1, 'Local Domain', 0, 80, '4.5.0.0', 5, 5, 1, false);
...
Insert into ts_apps(ts_id, ts_domain_id, ts_authtype_id, ts_apptype_id, ts_name, ts_description, ts_session_timeout, ts_user_processing_type, ts_case_sensitivity_url_host, ts_case_sensitivity_url_path, ts_case_sensitivity_query_name, ts_case_sensitivity_query_value, ts_case_sensitivity_cookie_name, ts_case_sensitivity_cookie_value, ts_case_sensitivity_post_name, ts_case_sensitivity_post_value, ts_case_sensitivity_login_name, ts_soft_delete, version_info) values(1, 1, 1, 2, 'Default Application', 'Default Application', 60, 0, false, true, true, true, false, true, true, true, true, false, 1);
...
Insert into ts_sm_web_servers(ts_id, ts_sm_group_id, ts_name, ts_from_ip_address, ts_to_ip_address, ts_ip_address_type, ts_port, ts_soft_delete, version_info) values(1, 1, 'Default SiteMinder Web Servers', 0, 4294967295, 1, 0, false, 1);
...
insert into ts_introscope_ems(ts_id, version_info, ts_name, ts_description, ts_username, ts_password, ts_hostname, ts_em_version, ts_web_view_version, ts_web_start_version, ts_port, ts_web_view_port, ts_web_start_port, ts_has_web_view, ts_has_web_start, ts_tran_trace_duration, ts_tran_trace_threshold_percentage, ts_enabled, ts_soft_delete)
 values (1, 1, '', '', 'Admin','','', '8.0', '', '',5001, 8080, 8081, false, false, 120, 25, false, false);
