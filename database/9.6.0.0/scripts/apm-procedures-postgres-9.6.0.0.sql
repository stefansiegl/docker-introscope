...
END;
$$ LANGUAGE plpgsql;
-- I commented out this as this leads to the documented error when sourcing this
-- using psql. I really do not understand why this should be necessary and thus
-- I removed it
--
